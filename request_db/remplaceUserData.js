		...
		const usersData = [
			{
				...
				firstname: "fname_admin",
				lastname: "lname_admin",
				pseudonyme: "pseudo_admin",
				role: "admin",
				sexe: "f",
				password: "admin_password",
				company: "you services",
			},
			{
				email: "user@locatethem.com",
				configurations: {
					theme: "light",
					language: "fr",
					timeAutoReload: true,
				...
				createdAt: "2024-12-18T10:30:00Z",
				updatedAt: "2024-12-18T10:30:00Z",
				firstname: "fname_user",
				lastname: "lname_user",
				pseudonyme: "pseudo_user",
				role: "user",
				sexe: "f",
